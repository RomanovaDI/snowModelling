...
class simulation():
	...
	def __init__(self):
		...
		#mat2 = FrictMat(young=young,poisson=0.5,frictionAngle=radians(15),density=density,label='wallmat')
		...
		#spheres
		#mn, mx= Vector3(minval + epsilon, minval + epsilon, minval + epsilon), Vector3(maxx - epsilon, maxy - epsilon, maxz - epsilon)
	...
	def particleFlow(self):
		#bf = BoxFactory(maxParticles=10000,extents=(0,0.4,0.2),center=(0,0.2,0.1),rMin=0.001,rMax=0.003,vMin=100,vMax=100,vAngle=0,massFlowRate=100./60,normal=(0,1.5,-1),label='factory',materialId='spheremat')
